      ...
      <Grid container spacing={0} >
        ...
        <Grid item xs={6} sm={4} md={3} lg={3}>
            <Item
              ...
              <Card  
              sx={{ border: '0.5px solid #d3d3d3', borderRadius: '4px',maxWidth: 300,paddingTop:'10px',height:'340px' }}>
                <CardMedia
                      component="img"
                      height="140"
                    ...
                    />
                  <CardContent>
                    <a href="/product_details" style={{textDecoration:'none'}}>
                      <Tooltip title="Fresh Ratnagiri Alphonso Mango : 6 Pieces (Approx. 220 gm - 230 gm Per Pc)" followCursor arrow>
                        <Typography  className="page-wrap"  variant="p" component="div"  sx={{color:'rgb(33 33 33)',textAlign:'left',overflow:'hidden',height:'40px',whiteSpace:'wrap',marginBottom:'10px',fontWeight:'600'}}>
                    ...
                    <Typography  className="page-wrap"  variant="p" component="div"  sx={{textAlign:'center',overflow:'hidden',whiteSpace:'wrap',marginBottom:'5px',fontWeight:'100',color:'#727272'}}>
                      <span><b style={{color:'red',fontWeight:'600'}}>Out Of Stock</b></span>
