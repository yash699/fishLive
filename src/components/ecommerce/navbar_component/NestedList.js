  ...
  return (
    ...
    >
      ...
      <ListItemButton onClick={handleClick}>
        ...
        <ListItemText primary="Fish / Seafood" />
      ...
      <Collapse in={open} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <ListItemButton sx={{ pl: 4 }}>
            ...
            <ListItemText primary="Bangda" />
          </ListItemButton>
           <ListItemButton sx={{ pl: 4 }}>
            <ListItemIcon>
              <StarBorder />
            </ListItemIcon>
            <ListItemText primary="Pomfret" />
          </ListItemButton>
           <ListItemButton sx={{ pl: 4 }}>
            <ListItemIcon>
              <StarBorder />
            </ListItemIcon>
            <ListItemText primary="Seer Fish" />
          </ListItemButton>
        </List>
      </Collapse>
    </List>
    ...
    <List
      ...
      aria-labelledby="nested-list-subheader"
      subheader={
        <ListSubheader component="div" id="nested-list-subheader" sx={{fontWeight:'600'}}>
          Help & Settings
        </ListSubheader>
      }
    >
